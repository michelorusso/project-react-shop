...
export const descriptionProduct = () => {
    ...
    function stampaCard(element: any, index: any) {
        return <>
            <div className="col-lg-3 col-md-6 col-xs-11 mb-4 mb-lg-0 ">
                    ...
                    <div className="card rounded shadow-sm border-0 ">
                        <div className="card-body p-4 moodText">
                            ...
                            <ul className="list-inline small d-flex flex-column text-dark infoCard">
                                <li className="list-inline-item m-0 text-dark">{star(element.Rate)}<i className="fa fa-star text-success"></i></li>
                                <li className="list-inline-item m-0 text-dark">{element.Promo ? parseFloat(element.Price - promo(element.Marca) * element.Price / 100 + '$').toFixed(2) : element.Price + '$'} {element.Promo ? <span className="scontato">{element.Price}$ </span> : ''}<i className="fa fa-star text-success"></i></li>
                                {
                                    element.gender.includes('Uomo') && element.gender.includes('Donna') ? <li className="list-inline-item m-0 text-dark">Unisex<i className="fa fa-star text-success"></i></li> : <li className="list-inline-item m-0 text-dark">{element.gender}<i className="fa fa-star text-success"></i></li>
                                }
    ...
    <section className="container">
        ...
        {arrayMagazine.readmagazine.magazine.map((element, index) => {
            return (element.Description.includes('Giacca') ? stampaCard(element, index) : '');
        })}
