      ...
      <nav>
        <div className="navSearch">
          <ul className="menu">
            <li>
              <Link to={"/"}>
                <img src={logo} width={"150px"} alt="logo fighissimo" />
              </Link>
            </li>
            <li>
              <div
                style={{ paddingTop: "5px" }}
                className="bg-white position-relative sear"
              >
                <label htmlFor="">
                  <Link
                    onClick={() => {
                    ...
                    to={"/search"}
                  >
                    <i className="fas fa-search bg-white text-dark pl-2 pr-3"></i>
                  </Link>
                </label>
                <input
                  id="search"
                ...
                {filtroSearch != "" ? (
                  <div
                    style={{ zIndex: "3" }}
                    className="searchChild position-absolute"
                  >
                    {newMagazine.map((element: any, i: number) => {
                      return (
                        <div>
                          {element.NameProduct.includes(filtroSearch) ? (
                            <div>
            ...
            <li>
              ...
              {arrayMagazine.LoginUser.log == false ? (
                <Link
                  className="link-light"
                  style={{ textDecoration: "none", paddingRight: "15px" }}
                  to={`/login`}
                ...
                <Link
                  ...
                  to={`/AdminPage`}
                >
                  {arrayMagazine.LoginUser.utenti[Master].nome}
                </Link>
              )}
                          ...
                          >
                            ...
                            <div className="textElementCart">
                              ...
                              {element.Price == null ? (
                                ...
                                <div>{`${element.Price}$ x ${element.QuantitySelected}`}</div>
                              )}
                            </div>
                          </div>
                          <hr />
